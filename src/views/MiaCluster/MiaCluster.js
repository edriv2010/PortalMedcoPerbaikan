...
//let cekNull=(impactValue?true:false )
      ...
      {
  //      alert(hsl)
        cekNull=goal&&typeNovelty && roi && hsl && level ?false : true;
           
      }else if(cekNull===false && impactValue==="Cost Saving")
      {
        cekNull=goal&&typeNovelty && cost && hsl && level ?false: true
      }else if(cekNull===false && impactValue==="HSE")
      {
        cekNull=goal&&typeNovelty && hse && hsl && level ?false: true
      } 
...
*/
  ...
  componentWillMount() {
    var arr =  [{
      "goal":["Type1","Type2","Type3"],"id": 1, "fullname": "Amir Santoso1", "empId": "0001"},
      {"goal":["Type1","Type2"],"id": 1, "fullname": "Amir Santoso1", "empId": "0001"},
    ]
...
//    console.log("res=");
 //   console.log("res=",res);
    ...
    let Users11 = ListA.filter((itemA)=> {
       return ListB.find((itemB)=> {
        if(itemA.goal)return itemA.goal.includes(itemB.goal);
      })
    })
    console.log("Users11=",Users11)
              ...
              <div class="col-md-12" style={{padding: '2px 0', backgroundColor: '#f0f0f0'}}>
                ...
                <div class="col-md-1"><span class="form-group">
                    ...
                    onChange={this.handleChangeSearch}>
                      ...
                      <option value="type2">Increased Efficiency</option>
                      <option value="type3">Environment Sustainability</option>
                      <option value="type4">Reduced Risk</option>
                      <option value="type5">Increase Operability and Maintainability</option>
                    </select>
                  </span>
                </div>
                <div class="col-md-1"><span class="form-group">
