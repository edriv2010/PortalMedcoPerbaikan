...
handleChangeGoal=event=> {
  ...
  if(target.checked){
      this.state.goal_var.push (value);   
  }else{
      this.state.goal_var.splice(value, 1);
  }
  this.valueFrom(this.state.goal_var,name)

  console.log("this.state.goal_var",this.state.goal_var)
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  onChange={ ( event, editor ) => {
                    ...
                    <div class="box-header with-border">
                      <h4 class="box-title">Value Add Goal</h4>
                    </div>
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" name="goal" id="optionsCheck" value="type1"
                              onChange={this.handleChangeGoal}/>
                              Increase Production and or Sustainability in Production </label>
                          </div>
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" name="goal" id="optionsCheck" value="type2"
                              onChange={this.handleChangeGoal}/>
                              Increased Efficiency</label>
                          </div>
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" name="goal" id="optionsCheck" value="type3"
                              onChange={this.handleChangeGoal}
                              />
                              Environment Sustainability </label>
                          </div>
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" name="goal" id="optionsCheck" value="type4"
                              onChange={this.handleChangeGoal}/>
                              Reduced Risk</label>
                          </div>
                          <div class="checkbox">
                            <label>
                              <input type="checkbox" name="goal" id="optionsCheck" value="type5"
                              onChange={this.handleChangeGoal}
                              />
                              Increase Operability and Maintainability</label>
                          </div>

                          <input type="text" class="form-control" id="inputTitle" placeholder="Reason" disabled /> <br />
                          <input type="file" class="filestyle" data-classButton="btn btn-default" 
                          data-input="false" data-classIcon="icon-upload" data-buttonText="Upload" disabled
                          />
                        </div>
                      </div>
                    </div>
